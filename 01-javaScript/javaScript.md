 ...
 * @LastEditTime: 2021-02-20 19:42:25
...
- [1. js数据类型](#1-js数据类型)
- [2. null 和 undefined 的区别](#2-null-和-undefined-的区别)
- [3. 数据类型相互转换规则](#3-数据类型相互转换规则)
  - [3.1. 其他类型转换成String](#31-其他类型转换成string)
  - [3.2. 其他类型转换成Number](#32-其他类型转换成number)
  - [3.3. 其他类型转换成Boolean](#33-其他类型转换成boolean)
- [4. 基本数据类型与引用数据类型的区别？](#4-基本数据类型与引用数据类型的区别)
- [5. typeof能否正确判断数据类型？instanceof 能判断对象的原理是什么](#5-typeof能否正确判断数据类型instanceof-能判断对象的原理是什么)
- [6. 手写instanceof](#6-手写instanceof)
- [7. 理解原型链](#7-理解原型链)
- [8. javaScript 继承的几种实现方式](#8-javascript-继承的几种实现方式)
- [9. js 遍历对象和遍历数组的方式](#9-js-遍历对象和遍历数组的方式)
  - [9.1. 遍历对象](#91-遍历对象)
  - [9.2. 遍历数组](#92-遍历数组)
- [10. valueOf 和 toString 的区别](#10-valueof-和-tostring-的区别)
- [11. {} 和 [] 的 valueOf 和 toString 的结果是什么](#11--和--的-valueof-和-tostring-的结果是什么)
...
## 5. typeof能否正确判断数据类型？instanceof 能判断对象的原理是什么
...
- Object.getOwnPropertyNames() 返回一个数组，包含对象自身的所有属性（不包含Symbol属性，但是包括不可，枚举属性）
...
## 10. valueOf 和 toString 的区别

https://juejin.cn/post/6873215243804213262

## 11. {} 和 [] 的 valueOf 和 toString 的结果是什么
